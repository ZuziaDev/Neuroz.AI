...
export type TfjsLayerConfig =
  | TfjsDenseLayerConfig
  | TfjsDropoutLayerConfig
  | TfjsEmbeddingLayerConfig
  | TfjsFlattenLayerConfig
  | TfjsGlobalAveragePooling1dLayerConfig
  | TfjsLstmLayerConfig
  | TfjsGruLayerConfig;
...
export interface CreateTfjsModelOptions
  extends CreateModelOptions<TfjsModelConfig> {}
