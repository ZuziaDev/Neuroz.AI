...
export interface ModerationRule {
  ...
  evaluate(
    context: ModerationRuleContext,
  ): ModerationRuleHit[] | Promise<ModerationRuleHit[]>;
}
...
export interface ModerationEngineOptions {
  ...
  webhook?:
    | ((event: ModerationWebhookEvent) => void | Promise<void>)
    | undefined;
...
export interface ModerationPlugin {
  ...
  afterPrediction?(
    request: ModerationRequest,
    prediction: ModerationPredictionResult | undefined,
  ): void | Promise<void>;
